...
export default function RewardedAdModal({
  ...
  useEffect(() => {
    ...
    secondsLeftRef.current = AD_DURATION;
    progress.setValue(0);
...
const styles = StyleSheet.create({
  ...
  container: { borderTopLeftRadius: 28, borderTopRightRadius: 28, borderWidth: 1, padding: 24, paddingBottom: 40, gap: 16, minHeight: 300 },
